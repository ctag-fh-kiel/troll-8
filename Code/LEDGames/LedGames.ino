...
#define CAP1188_LEDPOLARITY 0x73
#define CAP1188_LEDOUTPUTCTRL 0x74
#define CAP1188_LEDLINKEDTRANSCTRL 0x77
#define CAP1188_LEDMIRRORCTRL 0x79
#define CAP1188_LEDBHVCTRL_1 0x81
#define CAP1188_LEDBHVCTRL_2 0x82
#define CAP1188_LEDPULSE1 0x84
#define CAP1188_LEDPULSE2 0x85
#define CAP1188_LEDBREATHE 0x86
#define CAP1188_LEDCFG 0x88
#define CAP1188_LEDDC_1 0x90
#define CAP1188_LEDDC_2 0x91
#define CAP1188_LEDDC_B 0x92
#define CAP1188_LEDDC_D 0x93
#define CAP1188_LEDRAMPRT 0x94
#define CAP1188_LEDOFFDLY 0x95
...
void ledAnimationCS(){
  writeRegCS(0, CAP1188_LEDLINK, 0x00);
  writeRegCS(1, CAP1188_LEDLINK, 0x00);
  //writeRegCS(0, CAP1188_LEDBHVCTRL_1, 0xFF);
  byte leds = 0;
  for (int i=0; i < 4; i++){
    if (!(i%2)){
      for (int j=0; j < 4; j++){
        leds |= (0x08 >> j);
        leds |= (0x10 << j);
        writeRegCS(0, CAP1188_LEDOUTPUTCTRL, ~leds);
        writeRegCS(1, CAP1188_LEDOUTPUTCTRL, ~leds);
        delay(75);
      }
    }
    else {
  ...
  for (int i=0; i < 75; i++){
    if (i%2){
        writeRegCS(0, CAP1188_LEDOUTPUTCTRL, ~(0x00));
        writeRegCS(1, CAP1188_LEDOUTPUTCTRL, ~(0x00));
    }
    else{
        writeRegCS(0, CAP1188_LEDOUTPUTCTRL, ~(0xff));
        writeRegCS(1, CAP1188_LEDOUTPUTCTRL, ~(0xff));
    }
    delay(75-i);
  }
  writeRegCS(0, CAP1188_LEDLINK, 0xff);
  writeRegCS(1, CAP1188_LEDLINK, 0xff);
}
/**
   Main functions
*/
